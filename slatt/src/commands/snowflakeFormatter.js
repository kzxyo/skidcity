...
exports.msToHuman = function(n, ln){
    n = parseInt(n);
    let str = [];
    if (n >= 1000 * 60 * 60 * 24 * 365) cut(1000 * 60 * 60 * 24 * 365, ' years');
    ...
    if (n >= 1000 * 60 * 60 * 24) cut(1000 * 60 * 60 * 24, ' days');
    if (n >= 1000 * 60 * 60) cut(1000 * 60 * 60, ' hours');
    if (n >= 1000 * 60) cut(1000 * 60, ' minutes');
    if (n >= 1000) cut(1000,  ' seconds');
