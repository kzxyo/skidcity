...
async def stats():
  ...
  stat_log = bot.get_channel(1106564925763092517)
...
class Client(commands.AutoShardedBot):
  def __init__(self):
    super().__init__(
        ...
        owner_ids=[112635397481213952, 1107903478451408936]
    ) 
...
bot = Client()
bot.run("MTA3NTc5NzIyMTQ2NDg3MTAxMg.GQY_-6.k9L6e7UXNlk1BJplQR7ERcFU-XuJkPHOXWGoeA", reconnect=True)