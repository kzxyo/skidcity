...
class jail(commands.Cog):
    ...
    async def setme(self, ctx: commands.Context):
     ...
     async with self.bot.db.cursor() as cursor:
      ...
      if res is not None: return await sendmsg(self, ctx, None, discord.Embed(color=Colors.yellow, description=f"{Emojis.warning} {ctx.author.mention}: Jail is already set"), None, None, None)
    ...
    async def jail(self, ctx: commands.Context, member: discord.Member=None, *, reason=None):
     ...
     async with self.bot.db.cursor() as cursor: 
      ...
      try:
       ...
       success = discord.Embed(color=Colors.default, description=f"{Emojis.check} {member.mention} got jailed - {reason}")
       await sendmsg(self, ctx, None, success, None, None, None) 
      except Exception as e:
       embed = discord.Embed(color=Colors.default, description=f"{ctx.author.mention} there was a problem jailing {member.mention}")
       await sendmsg(self, ctx, None, embed, None, None, None) 
