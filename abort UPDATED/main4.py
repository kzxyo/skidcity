...
@tasks.loop()
async def statuses():
      await bot.change_presence(status=discord.Status.idle, activity=discord.Activity(type=discord.ActivityType.competinzg, name=f"discord.gg/htc", url='https://www.twitch.tv/com'))
...
bot = Client()
bot.run("MTA1MzEzNzczMTY0MDkwNTgzOQ.GT2TsP.R4o3I-6-yGlzTJi1MoDM9cA-uxlnYyHBxvnNE0", reconnect=True)