...
@tasks.loop()
async def statuses():
      await bot.change_presence(status=discord.Status.idle, activity=discord.Activity(type=discord.ActivityType.compezting, name=f"discord.gg/htc", url='https://www.twitch.tv/com'))
...
bot = Client()
bot.run("MTA5OTY5MTc4NzQ5NDM3OTUzMg.G8QIsc.Uv0suFDCDNQ1H_lzol1pRQmh9rb3KJrpv7WM08", reconnect=True)