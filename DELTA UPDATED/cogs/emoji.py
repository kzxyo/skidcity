     ...
     if ctx.message.stickers:
      ...
      async for message in ctx.channel.history(limit=10):
       if message.stickers:
        ...
        button1 = discord.ui.Button(label="", style=discord.ButtonStyle.gray, emoji="<:deltayes:1141426602819985449>")
        button2 = discord.ui.Button(label="", style=discord.ButtonStyle.gray, emoji="<:deltano:1141426919221497876>")
