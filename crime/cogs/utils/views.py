...
class Views:
    class Paginator(discord.ui.View):
        def __init__(self, *,
            ...
            self.previous_button = previous_button or discord.ui.Button(emoji="<:crimeleft:1082120060556021781>", style=discord.ButtonStyle.grey)
            self.next_button = next_button or discord.ui.Button(emoji="<:crimeright:1082120065853423627>", style=discord.ButtonStyle.grey)
