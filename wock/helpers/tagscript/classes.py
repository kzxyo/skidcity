...
class Tag:
    ...
    def __init__(self, parser, callback, name, description, aliases, *, parent=None, **attrs):
        self._tags = []
        self._parser = parser
    ...
    def tag(self, name: str = None, *, alias: str = None, aliases: typing.List[str] = None, **attrs):
        ...
        def decorator(func):
            ...
            tag_ = Tag(self.parser, func.callback if isinstance(func, Tag) else func, name_, aliases, parent=self, **attrs)
