...
class Body:
    ...
    def __init__(self, expected_content_length: Optional[int], max_content_length: Optional[int]) -> None:
        ...
        if expected_content_length is not None and max_content_length is not None and expected_content_length > max_content_length:
...
class Request(BaseRequestWebsocket):
    ...
    def __init__(
        ...
        *,
        ...
        """
        super().__init__(method, scheme, path, query_string, headers, root_path, http_version, scope)
    ...
    @overload
    async def get_data(self, cache: bool = True, as_text: bool = False, parse_form_data: bool = False) -> AnyStr:
        ...
