...
AfterRequestCallable = Union[Callable[["Response"], "Response"], Callable[["Response"], Awaitable["Response"]]]
...
TemplateContextProcessorCallable = Union[Callable[[], Dict[str, Any]], Callable[[], Awaitable[Dict[str, Any]]]]
