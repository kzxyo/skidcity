...
async def new_full_dispatch_request(self: Quart, request_context: Optional[RequestContext] = None) -> Union[Response, WerkzeugResponse]:
...
def new_ensure_async(self, func: Callable[..., Any]) -> Callable[..., Awaitable[Any]]:  # type: ignore
