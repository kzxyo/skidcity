...
class DispatchingJinjaLoader(BaseLoader):
    ...
    def get_source(self, environment: BaseEnvironment, template: str) -> Tuple[str, Optional[str], Optional[Callable[[], bool]]]:
...
async def stream_template(
    template_name_or_list: Union[str, Template, List[Union[str, Template]]],
    **context: Any,
) -> AsyncIterator[str]:
