...
class Music(commands.Cog):
    ...
    async def start_node(self):
      ...
      self.bot.node = await pomice.NodePool().create_node(bot=self.bot, host="narco.buses.rocks", port=2269, password="glasshost1984", identifier="MAIN", secure=False, spotify_client_id="38e4713253e147359a8c049425cdfff1", spotify_client_secret="c82c5d45ec4741f58b780b3a13cd8b44", apple_music=True)
