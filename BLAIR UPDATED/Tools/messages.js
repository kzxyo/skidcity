...
module.exports = class Messages {
    ...
    parse (code) {
        ...
        for (const match of buttonMatches || []) {
            ...
            if (button.label || button.emoji) {
                if (style === 'Link') {
                    ...
                    button.customId = this.bot.util.random('abcdefghijklmnopqrstuvwxyz1234567890', 10) 
                }
        ...
        message = code.replace(setRegex, '').replace(embedRegex, '').replace(buttonRegex, '').slice(0, 2000).trim()
