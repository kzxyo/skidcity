...
module.exports = class Hug extends Command {
    ...
    async run(message, args) {
        ...
        fetch('http://api.nekos.fun:8080/api/cuddle').then(response => response.json()).then(res => {
            if (!res) {
            ...
            const embed = new MessageEmbed()
                ...
                .setDescription(`**${message.member.nickname || message.member.user.username}** cuddles **${member.nickname || member.user.username}**`)
                .setImage(res.image)
