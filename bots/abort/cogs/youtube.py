                            ...
                            if YouTube(x).length < 300:
                                try:
                                    async with message.channel.typing():
                                        yt = YouTube(x).streams.get_highest_resolution().download("abort.mp4")
                                        ...
                                        await message.channel.send(file=discord.File(yt, filename="abort.mp4"), embed=embed)
