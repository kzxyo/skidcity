...
class skullboard(commands.Cog):
    ...
    @commands.hybrid_group(name = "skullboard", description = "Show all skull commands",aliases=['skull'], usage = "skullboard")
    ...
    async def skullboard(self, ctx):
        ...
        ex.set_footer(
            text=f"skull",
            icon_url="https://cdn.discordapp.com/avatars/1107283467655458866/63afc4ecef5d25ceafe4080aab1d1c64.png?size=4096",
        )
