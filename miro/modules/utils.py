import discord, json, datetime, typing, aiohttp, difflib, sys, io, os, humanize, importlib, inspect
...
async def help(ctx):
    ...
    embed.set_thumbnail(url="attachment://Miro.png")
...
{cmd.brief}'''}```""",
    ...
    await ctx.reply(embed=embed, file=discord.File("Miro.png"))
...
async def send_help(ctx):
    ...
    if isinstance(ctx.command, commands.Command):
        ...
        paginator.add_button("prev", emoji="<:miroleft:1115337787294634024>")
        paginator.add_button("goto", emoji="<:filter:1113850464832868433>")
        paginator.add_button("next", emoji="<:arrowright:1115322707580571769>")
        paginator.add_button("delete", emoji="<:denyp:1113553505903456366>")
...
class MessageSnipe:
    def __init__(
        ...
        self._author_color = 0x4c5264 if not author.color else author.color
