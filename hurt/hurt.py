...
async def female():
    ...
    embed = discord.Embed(
        color=0x2F3136,
        description="[our pinterest](https://www.pinterest.com/antipfps/)",
        timestamp=datetime.datetime.now(),
    )
    embed.set_image(url=links)
    embed.set_author(
        name="follow our pinterest",
        icon_url="https://images-ext-1.discordapp.net/external/patbltTGq126PE_DJ-ZVbxORqhW8cipRzo95lYr6FaE/%3Fsize%3D240%26quality%3Dlossless/https/cdn.discordapp.com/emojis/1026647994390552666.webp",
    )
...
class crime(commands.AutoShardedBot):
    def __init__(self):
        super().__init__(
            ...
            owner_ids=[843904399708651550, 1133822924906844202, 961409108286795917],
        )
