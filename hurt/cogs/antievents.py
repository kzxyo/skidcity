...
class antievents(commands.Cog):
    ...
    async def on_member_join(self, member):
        ...
        if age < minage and aa == True:
            try:
                await member.kick(reason="hurt anti-alt")
            except:
                pass
        ...
        try:
            if member.bot:
                ...
                reason = "hurt antinuke: anti bot is enabled"
                ...
                if (
                    ...
                    await target.kick(reason=f"hurt antinuke: anti bot is enabled")
    ...
    async def on_member_remove(self, member):
        ...
        try:
            ...
            reason = "hurt antinuke: anti kick is enabled"
            anti = util.read_json("antinuke")[str(member.guild.id)]
            try:
    ...
    async def on_guild_channel_delete(self, channel):
        try:
            ...
            reason = "hurt antinuke: anti channel delete is enabled"
            anti = util.read_json("antinuke")[str(channel.guild.id)]
            if (
                executor.id != anti["owner"]
                and executor.id not in anti["whitelisted"]
    ...
    async def on_guild_role_create(self, role):
        try:
            ...
            reason = "hurt antinuke: anti role create is enabled"
    ...
    async def on_guild_role_delete(self, role):
        try:
            ...
            reason = "hurt antinuke: anti role delete is enabled"
            anti = util.read_json("antinuke")[str(role.guild.id)]
            if (
                executor.id != anti["owner"]
                and executor.id not in anti["whitelisted"]
    ...
    async def on_guild_update(self, before, after):
        try:
            ...
            reason = "hurt antinuke: anti guild update is enabled"
            anti = util.read_json("antinuke")[str(guild.id)]
    ...
    async def on_webhooks_update(self, channel):
        try:
            ...
            reason = "hurt antinuke: anti webhook spam is enabled"
            anti = util.read_json("antinuke")[str(guild.id)]
            if (
                executor.id != anti["owner"]
                and executor.id not in anti["whitelisted"]
            ...
            reason2 = "hurt antinuke: anti webhook spam is enabled"
            anti = util.read_json("antinuke")[str(guild.id)]
            if (
                executor.id != anti["owner"]
                and executor.id not in anti["whitelisted"]
