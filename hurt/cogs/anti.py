...
async def antisetup(ctx: commands.Context):
    ...
    if not discord.utils.get(ctx.guild.text_channels, name="hurt-logs"):
        y = await ctx.guild.create_text_channel(name="hurt-logs")

    else:
        y = discord.utils.get(ctx.guild.text_channels, name="hurt-logs")
...
class antinuke(commands.Cog):
    ...
    async def settings(self, ctx):
        ...
        try:
            ...
            try:
                x = discord.utils.get(ctx.guild.text_channels, name="hurt-logs")
                x = x.mention
            except:
                x = await ctx.guild.create_text_channel(name="hurt-logs")
                x = x.mention
        ...
        se.add_field(
            ...
            value=f"> **status:** {'<:icons_on:1139292930222342195>' if vanity == 'on' else '<:icons_off:1139292890825240646>'}",
        )
        se.add_field(
            name=f"Role Create",
            value=f"> **status:** {'<:icons_on:1139292930222342195>' if rolecreate == 'on' else '<:icons_off:1139292890825240646>'}",
        )
        se.add_field(
            name=f"Role Delete",
            value=f"> **status:** {'<:icons_on:1139292930222342195>' if roledelete == 'on' else '<:icons_off:1139292890825240646>'}",
        )
        se.add_field(
            name=f"Logs Channel",
        ...
        se.add_field(
            ...
            value=f"> **status:** {'<:icons_on:1139292930222342195>' if channelcreate == 'on' else '<:icons_off:1139292890825240646>'}",
        )
        se.add_field(
            name=f"Channel Create",
            value=f"> **status:** {'<:icons_on:1139292930222342195>' if channeldelete == 'on' else '<:icons_off:1139292890825240646>'}",
        )
        se.add_field(
            name=f"Member Ban",
            value=f"> **status:** {'<:icons_on:1139292930222342195>' if ban == 'on' else '<:icons_off:1139292890825240646>'}",
        )
        se.add_field(
            name=f"Member Kick",
            value=f"> **status:** {'<:icons_on:1139292930222342195>' if kick == 'on' else '<:icons_off:1139292890825240646>'}",
        )
        se.add_field(
            name=f"Webhook Spam",
            value=f"> **status:** {'<:icons_on:1139292930222342195>' if webhook == 'on' else '<:icons_off:1139292890825240646>'}",
        )
        se.add_field(
            name=f"Guild Update",
            value=f"> **status:** {'<:icons_on:1139292930222342195>' if guild == 'on' else '<:icons_off:1139292890825240646>'}",
        )
        se.add_field(
            name=f"Alt Join",
            value=f"> **status:** {'<:icons_on:1139292930222342195>' if antialt == 'on' else '<:icons_off:1139292890825240646>'}",
        )
        se.add_field(
            name=f"Bot Add",
            value=f"> **status:** {'<:icons_on:1139292930222342195>' if antibot == 'on' else '<:icons_off:1139292890825240646>'}",
        )
